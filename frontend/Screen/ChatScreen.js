...
class ChatScreen extends Component {
    constructor(props){
        super(props);
        this.entranceYear = AsyncStorage.getItem("entranceYear");
        this.department = AsyncStorage.getItem("department");
        //this.entranceYear = this.props.route.params.entranceYear;
        ...
        if(this.department){
            ...
            this.departmentId = this.departmentId + this.entranceYear[2] + this.entranceYear[3]
;        }
    ...
    componentDidMount(){
        ...
        var danbee_url = "https://danbee.ai/chatflow/chatbot/v2.0/1d1e0598-3c44-4a8e-bd41-908a9c14846a/welcome.do";
        ...
        axios(options).then((res) =>{
            ...
            var tmpMessage = {
                ...
                user: {
                    _id: 2,
                    name: 'React Native',
                    avatar: 'https://blog.kakaocdn.net/dn/esugIB/btqwv7PLOZT/oMb10ItMqbhdX0dKomtDQ0/img.jpg',
            ...
            console.log(this.department + this.entranceYear);
        });
    ...
    render(){
        ...
        const onSend = (messages) =>{
            ...
            var danbee_url = "https://danbee.ai/chatflow/chatbot/v2.0/1d1e0598-3c44-4a8e-bd41-908a9c14846a/message.do";
                ...
                if(res.data.responseSet.result.another_result[0]){
                    ...
                    for(var i in res.data.responseSet.result.another_result){
                        ...
                        send = {
                            _id: cnt+10000,
                            text: <Text 
                            style={{fontStyle: 'italic', fontWeight: 'bold', textDecorationLine: 'underline'}}
                            onPress = {(event) => {
                        ...
                        onSend(tmp);
                            ...
                            }>{res.data.responseSet.result.another_result[i].intent_name}</Text>,
                            createdAt: new Date(),
                            user: {
                                _id: 2,
                                name: 'React Native',
